...
function Created()
{
	...
	// UT99_ANDROID_V135_LEAN_MENU:
	// Keep only the Android-relevant multiplayer entries.
	// LAN browser/native autoscan is disabled; manual IP join remains via Open Location.
