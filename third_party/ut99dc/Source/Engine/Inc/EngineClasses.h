...
{
public:
    BYTE MoverEncroachType GCC_ALIGN(4); /* Keep out of ABrush tail padding on LP64. */
    BYTE MoverGlideType;
    BYTE BumpType;
    BYTE KeyNum;
    BYTE PrevKeyNum;
...
{
public:
    PTRINT Context; // Really a FMD5Context*; script placeholder is widened by UStruct::Link.
...
public:
    ...
    PTRINT LogAr GCC_PACK(4); // Really a FArchive*; script placeholder is widened by UStruct::Link.
...
{
public:
    BYTE TeamNumber GCC_ALIGN(4); /* Keep out of ANavigationPoint tail padding on LP64. */
