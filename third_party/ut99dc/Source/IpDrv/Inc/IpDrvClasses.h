...
public:
    ...
    INT Port;
    INT RemoteSocket;
    PTRINT PrivateResolveInfo; // Really a FResolveInfo*; script placeholder is widened by UStruct::Link.
    INT DataPending;
    BYTE ReceiveMode;
...
{
public:
    BYTE LinkState GCC_ALIGN(4); /* Keep out of AInternetLink tail padding on LP64. */
    FIpAddr RemoteAddr;
